...
const DataFetching = () => {
  ...
  const imgList = [
    "https://i.picsum.photos/id/625/536/354.jpg?hmac=jBI5estK5IS3_Ux9B3Io49XVEtNBulVMmlQ4DDXqXb4",
  ...
  return (
    <>
      ...
      <div>
        ...
        {dataState === "PENDING" ? (
          <>
          <ImageLoader src={"https://i.picsum.photos/id/625/536/354.jpg?hmac=jBI5estK5IS3_Ux9B3Io49XVEtNBulVMmlQ4DDXqXb4"} lazyLoading={true} onLoad={(e)=> console.log("load bitch", e.target)} />
        ...
        <ImageLoader src={"https://picsum.photos/1600/500?random=1"} lazyLoading={true} onLoad={(e)=> console.log("load bitch", e.target)} />

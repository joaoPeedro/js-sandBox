...
function solution(E, L) {
    ...
    let hours = exit[0] - entrace[0]
    let minutes = exit[1] - entrace[1]

    let totalTime = hours * 60 + minutes;

    cost = Math.ceil((totalTime - 60) / 60) * costHour


    // console.log({E,L, hours, minutes, totalTime})

    return cost + fee + firstHour
}

console.log( solution("10:00", "13:21"))
console.log( solution("00:30", "3:11"))
